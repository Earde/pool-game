...
var GameFunctions = (function () {
    ...
    GameFunctions.prototype.checkForHoles = function (balls, holes) {
    ...
    GameFunctions.prototype.checkForWalls = function (balls, walls, delta) {
        for (var b = 0; b < balls.length; b++) {
            if (!balls[b].hit) {
                //check for walls and bounce back if colliding
    ...
    GameFunctions.prototype.checkForWallsAndBalls = function (balls, walls, delta) {
    ...
    GameFunctions.prototype.processHoles = function (balls, players, tableWidth) {
        var halfScore = 0;
        var fullScore = 0;
        var halfHit = 0;
    ...
    GameFunctions.prototype.update = function (creator, delta, spacePressed, camera, mouseX, mouseY) {
